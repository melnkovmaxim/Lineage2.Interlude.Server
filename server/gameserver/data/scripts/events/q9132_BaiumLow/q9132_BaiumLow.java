...
public class q9132_BaiumLow extends QuestJython {

    //рб
    private final static int BOSS_ID = 41008;
    // локация
    private final static int[] BOSS_LOC = {190561, 21451, -3662};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 5 минут появится Baium Low, Global GK > ТОП РБ > Дневной Эпик";
    private final static String ANNOUNCE_SPAWN = "Baium Low появился, Global GK > ТОП РБ > Дневной Эпик";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "16:15";
    ...
    public static void main(String... arguments) {
        new q9132_BaiumLow(9132, "q9132_BaiumLow", "Baium Low");
    }

    public q9132_BaiumLow(int questId, String name, String descr) {
