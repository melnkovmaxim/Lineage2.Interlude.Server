package events.q9131_ValakasLow;
...
public class q9131_ValakasLow extends QuestJython {

    //рб
    private final static int BOSS_ID = 41007;
    // локация
    private final static int[] BOSS_LOC = {190561, 21451, -3662};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 5 минут появится Valakas Low, Global GK > ТОП РБ > Дневной Эпик";
    private final static String ANNOUNCE_SPAWN = "Valakas Low появился, Global GK > ТОП РБ > Дневной Эпик";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "17:45";
    ...
    public static void main(String... arguments) {
        new q9131_ValakasLow(9131, "q9131_ValakasLow", "Valakas Low");
    }

    public q9131_ValakasLow(int questId, String name, String descr) {
