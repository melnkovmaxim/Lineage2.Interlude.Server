...
public class q9119_Baium extends QuestJython {

    //рб
    private final static int BOSS_ID = 41003;
    // локация
    private final static int[] BOSS_LOC = {115200, 16615, 10076};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 5 минут появится Baium, Global GK > ТОП РБ > Baium";
    private final static String ANNOUNCE_SPAWN = "Baium появился, Global GK > ТОП РБ > Baium";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "21:00";
    ...
    public static void main(String... arguments) {
        new q9119_Baium(9119, "q9119_Baium", "Baium");
    }

    public q9119_Baium(int questId, String name, String descr) {
