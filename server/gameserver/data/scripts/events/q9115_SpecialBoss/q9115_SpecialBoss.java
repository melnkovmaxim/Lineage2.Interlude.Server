package events.q9115_SpecialBoss;
...
public class q9115_SpecialBoss extends QuestJython {

    //рб
    private final static int BOSS_ID = 200035;
    // локация
    private final static int[] BOSS_LOC = {77023, 245790, -10377};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 5 минут появится Clan RB (Дроп - 1 Ares Clan Skill), Global GK > ТОП РБ > Clan RB";
    ...
    private final static String BOSS_SPAWN_TIME = "20:00";
    ...
    public static void main(String... arguments) {
        new q9115_SpecialBoss(9115, "q9115_SpecialBoss", "SpecialBoss");
    }

    public q9115_SpecialBoss(int questId, String name, String descr) {
