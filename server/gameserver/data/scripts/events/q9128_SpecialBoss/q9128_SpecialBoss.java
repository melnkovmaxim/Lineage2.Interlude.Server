package events.q9128_SpecialBoss;
...
public class q9128_SpecialBoss extends QuestJython {

    //рб
    private final static int BOSS_ID = 319202;
    // локация
    private final static int[] BOSS_LOC = {53294, -88015, -2422};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 2 минут появится Fafurion Mini (Дроп - 1 Event Coin, 5 Weapon/Armor Enchant), Global GK > Мини Эпик Боссы";
    private final static String ANNOUNCE_SPAWN = "Fafurion Mini появился, Global GK > Мини Эпик Боссы";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "12:30;13:30;14:30;15:30;16:30;17:30;18:30;19:30;20:30;21:30;22:30;23:30;00:30;01:30";
    ...
    public static void main(String... arguments) {
        new q9128_SpecialBoss(9128, "q9128_SpecialBoss", "SpecialBoss");
    }

    public q9128_SpecialBoss(int questId, String name, String descr) {
