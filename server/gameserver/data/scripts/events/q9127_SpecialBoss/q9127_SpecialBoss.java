package events.q9127_SpecialBoss;
...
public class q9127_SpecialBoss extends QuestJython {

    //рб
    private final static int BOSS_ID = 319201;
    // локация
    private final static int[] BOSS_LOC = {53294, -88015, -2422};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 2 минут появится Valakas Mini (Дроп - 1 Event Coin, 5 Weapon/Armor Enchant), Global GK > Мини Эпик Боссы";
    private final static String ANNOUNCE_SPAWN = "Valakas Mini появился, Global GK > Мини Эпик Боссы";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "12:15;13:15;14:15;15:15;16:15;17:15;18:15;19:15;20:15;21:15;22:15;23:15;00:15;01:15";
    ...
    public static void main(String... arguments) {
        new q9127_SpecialBoss(9127, "q9127_SpecialBoss", "SpecialBoss");
    }

    public q9127_SpecialBoss(int questId, String name, String descr) {
