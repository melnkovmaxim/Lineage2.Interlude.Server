package events.q9122_SpecialBoss;
...
public class q9122_SpecialBoss extends QuestJython {

    //рб
    private final static int BOSS_ID = 44447;
    // локация
    private final static int[] BOSS_LOC = {-32004, 184590, -4209};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 5 минут появится Топаз (Дроп - 1 Топаз Шанс 70%), Global GK > Камни РБ";
    private final static String ANNOUNCE_SPAWN = "Топаз появился, Global GK > Камни РБ";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "15:00;16:30";
    ...
    public static void main(String... arguments) {
        new q9122_SpecialBoss(9122, "q9122_SpecialBoss", "SpecialBoss");
    }

    public q9122_SpecialBoss(int questId, String name, String descr) {
