package events.q9126_SpecialBoss;
...
public class q9126_SpecialBoss extends QuestJython {

    //рб
    private final static int BOSS_ID = 319200;
    // локация
    private final static int[] BOSS_LOC = {53294, -88015, -2422};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 2 минут появится Antharas Mini (Дроп - 1 Event Coin, 5 Weapon/Armor Enchant), Global GK > Мини Эпик Боссы";
    private final static String ANNOUNCE_SPAWN = "Antharas Mini появился, Global GK > Мини Эпик Боссы";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "12:00;13:00;14:00;15:00;16:00;17:00;18:00;19:00;20:00;21:00;22:00;23:00;00:00;01:00";
    ...
    public static void main(String... arguments) {
        new q9126_SpecialBoss(9126, "q9126_SpecialBoss", "SpecialBoss");
    }

    public q9126_SpecialBoss(int questId, String name, String descr) {
