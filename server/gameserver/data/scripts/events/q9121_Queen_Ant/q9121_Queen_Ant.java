package events.q9121_Queen_Ant;
...
public class q9121_Queen_Ant extends QuestJython {

    //рб
    private final static int BOSS_ID = 41005;
    // локация
    private final static int[] BOSS_LOC = {-21589, 179466, -5835};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 5 минут появится Queen Ant, Global GK > ТОП РБ > Queen Ant";
    private final static String ANNOUNCE_SPAWN = "Queen Ant появился, Global GK > ТОП РБ > Queen Ant";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "19:00";
    ...
    public static void main(String... arguments) {
        new q9121_Queen_Ant(9121, "q9121_Queen_Ant", "Queen Ant");
    }

    public q9121_Queen_Ant(int questId, String name, String descr) {
