...
public class q9130_ZakenLow extends QuestJython {

    //рб
    private final static int BOSS_ID = 41006;
    // локация
    private final static int[] BOSS_LOC = {190561, 21451, -3662};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 5 минут появится Zaken Low, Global GK > ТОП РБ > Дневной Эпик";
    private final static String ANNOUNCE_SPAWN = "Zaken Low появился, Global GK > ТОП РБ > Дневной Эпик";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "15:30";
    ...
    public static void main(String... arguments) {
        new q9130_ZakenLow(9130, "q9130_ZakenLow", "Zaken Low");
    }

    public q9130_ZakenLow(int questId, String name, String descr) {
