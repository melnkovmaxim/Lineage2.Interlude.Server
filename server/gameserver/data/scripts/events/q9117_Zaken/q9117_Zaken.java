...
public class q9117_Zaken extends QuestJython {

    //рб
    private final static int BOSS_ID = 41001;
    // локация
    private final static int[] BOSS_LOC = {55279, 219103, -3226};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 5 минут появится Zaken, Global GK > ТОП РБ > Zaken";
    private final static String ANNOUNCE_SPAWN = "Zaken появился, Global GK > ТОП РБ > Zaken";
    ...
    public static void main(String... arguments) {
        new q9117_Zaken(9117, "q9117_Zaken", "Zaken");
    }

    public q9117_Zaken(int questId, String name, String descr) {
