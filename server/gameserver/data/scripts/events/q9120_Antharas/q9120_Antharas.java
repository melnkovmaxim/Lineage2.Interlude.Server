...
public class q9120_Antharas extends QuestJython {

    //рб
    private final static int BOSS_ID = 41004;
    // локация
    private final static int[] BOSS_LOC = {177888, 114905, -7709};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 5 минут появится Antharas, Global GK > ТОП РБ > Antharas";
    private final static String ANNOUNCE_SPAWN = "Antharas появился, Global GK > ТОП РБ > Antharas";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "22:00";
    ...
    public static void main(String... arguments) {
        new q9120_Antharas(9120, "q9120_Antharas", "Antharas");
    }

    public q9120_Antharas(int questId, String name, String descr) {
