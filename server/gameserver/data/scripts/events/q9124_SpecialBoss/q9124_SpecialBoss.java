package events.q9124_SpecialBoss;
...
public class q9124_SpecialBoss extends QuestJython {

    //рб
    private final static int BOSS_ID = 44449;
    // локация
    private final static int[] BOSS_LOC = {-30326, 185561, -4168};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 5 минут появится Алмаз (Дроп - 1 Алмаз Шанс 70%), Global GK > Камни РБ";
    private final static String ANNOUNCE_SPAWN = "Алмаз появился, Global GK > Камни РБ";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "15:45;17:15";
    ...
    public static void main(String... arguments) {
        new q9124_SpecialBoss(9124, "q9124_SpecialBoss", "SpecialBoss");
    }

    public q9124_SpecialBoss(int questId, String name, String descr) {
