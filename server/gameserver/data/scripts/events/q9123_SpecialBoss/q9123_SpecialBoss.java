package events.q9123_SpecialBoss;
...
public class q9123_SpecialBoss extends QuestJython {

    //рб
    private final static int BOSS_ID = 44448;
    // локация
    private final static int[] BOSS_LOC = {-30743, 184158, -4209};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 5 минут появится Рубин (Дроп - 1 Рубин Шанс 70%), Global GK > Камни РБ";
    private final static String ANNOUNCE_SPAWN = "Рубин появился, Global GK > Камни РБ";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "15:15;16:45";
    ...
    public static void main(String... arguments) {
        new q9123_SpecialBoss(9123, "q9123_SpecialBoss", "SpecialBoss");
    }

    public q9123_SpecialBoss(int questId, String name, String descr) {
