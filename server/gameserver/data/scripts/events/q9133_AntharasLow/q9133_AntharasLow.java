package events.q9133_AntharasLow;
...
public class q9133_AntharasLow extends QuestJython {

    //рб
    private final static int BOSS_ID = 41009;
    // локация
    private final static int[] BOSS_LOC = {190561, 21451, -3662};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 5 минут появится Antharas Low, Global GK > ТОП РБ > Дневной Эпик";
    private final static String ANNOUNCE_SPAWN = "Antharas Low появился, Global GK > ТОП РБ > Дневной Эпик";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "17:00";
    ...
    public static void main(String... arguments) {
        new q9133_AntharasLow(9133, "q9133_AntharasLow", "Antharas Low");
    }

    public q9133_AntharasLow(int questId, String name, String descr) {
