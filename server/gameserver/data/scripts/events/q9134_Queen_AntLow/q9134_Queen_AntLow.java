package events.q9134_Queen_AntLow;
...
public class q9134_Queen_AntLow extends QuestJython {

    //рб
    private final static int BOSS_ID = 41010;
    // локация
    private final static int[] BOSS_LOC = {190561, 21451, -3662};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 5 минут появится Queen Ant Low, Global GK > ТОП РБ > Дневной Эпик";
    private final static String ANNOUNCE_SPAWN = "Queen Ant Low появился, Global GK > ТОП РБ > Дневной Эпик";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "14:45";
    ...
    public static void main(String... arguments) {
        new q9134_Queen_AntLow(9134, "q9134_Queen_AntLow", "Queen Ant Low");
    }

    public q9134_Queen_AntLow(int questId, String name, String descr) {
