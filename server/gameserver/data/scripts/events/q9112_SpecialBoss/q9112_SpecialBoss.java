package events.q9112_SpecialBoss;
...
public class q9112_SpecialBoss extends QuestJython {

    //рб
    private final static int BOSS_ID = 25163;
    // локация
    private final static int[] BOSS_LOC = {102060, 102469, -3537};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 10 минут появится Хиро Рейд Босс (Хиро получают все кто в пати), Global GK > ТОП РБ";
    private final static String ANNOUNCE_SPAWN = "Хиро Рейд Босс (Хиро получают все кто в пати) появился, Global GK > ТОП РБ";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "21:30";
    ...
    public static void main(String... arguments) {
        new q9112_SpecialBoss(9112, "q9112_SpecialBoss", "SpecialBoss");
    }

    public q9112_SpecialBoss(int questId, String name, String descr) {
