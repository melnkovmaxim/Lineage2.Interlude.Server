package events.q9114_SpecialBoss;
...
public class q9114_SpecialBoss extends QuestJython {

    //рб
    private final static int BOSS_ID = 200022;
    // локация
    private final static int[] BOSS_LOC = {77023, 245790, -10377};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 10 минут появится Clan RB (Дроп - 1 Ares Clan Skill), Global GK > ТОП РБ > Clan RB";
    private final static String ANNOUNCE_SPAWN = "Clan RB (Дроп - 1 Ares Clan Skill) появился, Global GK > ТОП РБ > Clan RB";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "19:45;20:45";
    ...
    public static void main(String... arguments) {
        new q9114_SpecialBoss(9114, "q9114_SpecialBoss", "SpecialBoss");
    }

    public q9114_SpecialBoss(int questId, String name, String descr) {
