package events.q9116_SpecialBoss;
...
public class q9116_SpecialBoss extends QuestJython {

    //рб
    private final static int BOSS_ID = 200036;
    // локация
    private final static int[] BOSS_LOC = {58844, -83373, -2671};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 5 минут появится Clan RB (Мирный) (Дроп - 1 Ares Clan Skill), Global GK > ТОП РБ > Clan RB (Мирный)";
    private final static String ANNOUNCE_SPAWN = "Clan RB (Мирный) (Дроп - 1 Ares Clan Skill) появился, Global GK > ТОП РБ > Clan RB (Мирный)";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "18:30";
    ...
    public static void main(String... arguments) {
        new q9116_SpecialBoss(9116, "q9116_SpecialBoss", "SpecialBoss");
    }

    public q9116_SpecialBoss(int questId, String name, String descr) {
