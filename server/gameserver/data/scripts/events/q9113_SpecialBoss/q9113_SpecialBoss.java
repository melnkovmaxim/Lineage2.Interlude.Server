package events.q9113_SpecialBoss;
...
public class q9113_SpecialBoss extends QuestJython {

    //рб
    private final static int BOSS_ID = 41101;
    // локация
    private final static int[] BOSS_LOC = {-93608, 95621, -3521};

    //  чтобы был анонс (текст вывод в конфиг)
    private final static String ANNOUNCE_TEXT = "Через 10 минут появится Шкатулка РБ (Дроп - 1 Шкатулка), Global GK > ТОП РБ";
    private final static String ANNOUNCE_SPAWN = "Шкатулка РБ (Дроп - 1 Шкатулка) появился, Global GK > ТОП РБ";

    // который будет появляться каждый день в 20:00 по мск (т.е., чтобы запускался как осада по времени компа)
    private final static String BOSS_SPAWN_TIME = "20:30";
    ...
    public static void main(String... arguments) {
        new q9113_SpecialBoss(9113, "q9113_SpecialBoss", "SpecialBoss");
    }

    public q9113_SpecialBoss(int questId, String name, String descr) {
