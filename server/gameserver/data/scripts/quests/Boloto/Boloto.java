...
public class Boloto extends QuestJython
{
	//NPC
	private final static int npcId = 59000;
	private final static int[] MOBS = {20160};
    private final static int RaidBoss = 29047;
	//QuestItem
	private final static int BLACK_FEATHER = 13018;
    private final static int ITEM_FROM_RB = 13019;
    //Chance from mobs
    private final static int chance1 = 75;
    //Chance from RB
    private final static int chance2 = 100;
	//Item
	private final static int FEATHER = 13020;
    private int count;
	...
	public Boloto(int questId, String name, String descr)
	{
				...
				for (int id : MOBS)
					if (npcId == id)
						if (Rnd.get(100) < chance1)
							if (st.getPlayer().getInventory().getInventoryItemCount(BLACK_FEATHER,0) < 100)
