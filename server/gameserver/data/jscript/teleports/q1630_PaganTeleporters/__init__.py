...
from ru.agecold.gameserver.model.entity import TvTEvent

qn = "q1630_PaganTeleporters"
...
class Quest (JQuest):
  ...
  def onTalk (self,npc,player):
    ...
    elif TvTEvent.isParticipating() or TvTEvent.isStarted():
       htmltext = "<html><body>Вы не можете войти, пока идет TvT евент...</body></html>"
