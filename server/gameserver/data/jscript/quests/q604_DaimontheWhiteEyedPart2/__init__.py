 ...
 def onAdvEvent (self, event, npc, player) :
   ...
   if event == "31683-02.htm" : 
      if st.getPlayer().getLevel() < 73 : 
       ...
       resp = self.loadGlobalQuestVar("respawn")
       if resp != "" and long(resp) > System.currentTimeMillis():
           htmltext = "31541-06.htm"
       elif st.getQuestItemsCount(S_SUMMON) == 0 :
         ...
         self.saveGlobalQuestVar("respawn", str(System.currentTimeMillis() + INTERVAL))
