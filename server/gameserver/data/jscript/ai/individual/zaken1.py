...
class zaken (JQuest) :
 ...
 def spawnMe(self):
   ...
   self.addSpawn(29022,55236,219082,GeoData.getInstance().getSpawnHeight(55236,219082, -3225, -3225, None),30000,False,0)
   return
...
QUEST = zaken1(-1, qn, "ai")

QUEST.addKillId(29022)
