...
public final class Static {
    ...
    public static String LH_TELEPORT_AFTER;
    public static String LH_BATTLE_START;
    ...
    public static void init() {
        ...
        LH_TELEPORT_AFTER = CustomServerData.getInstance().getMessage(132);
        LH_BATTLE_START = CustomServerData.getInstance().getMessage(133);
