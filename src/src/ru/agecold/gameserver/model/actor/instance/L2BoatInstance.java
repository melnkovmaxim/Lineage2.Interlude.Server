...
import ru.agecold.gameserver.model.actor.knownlist.BoatKnownList;
...
import ru.agecold.gameserver.network.serverpackets.OnVehicleCheckLocation;
import ru.agecold.gameserver.network.serverpackets.PlaySound;
import ru.agecold.gameserver.network.serverpackets.VehicleDeparture;
...
public class L2BoatInstance extends L2Character
{
	...
	/* (non-Javadoc)
	 * @see ru.agecold.gameserver.model.L2Character#updateAbnormalEffect()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ru.agecold.gameserver.model.L2Character#getActiveWeaponInstance()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ru.agecold.gameserver.model.L2Character#getActiveWeaponItem()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ru.agecold.gameserver.model.L2Character#getSecondaryWeaponInstance()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ru.agecold.gameserver.model.L2Character#getSecondaryWeaponItem()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ru.agecold.gameserver.model.L2Character#getLevel()
	 */
	@Override
	public int getLevel()
	{
	...
	/* (non-Javadoc)
	 * @see ru.agecold.gameserver.model.L2Object#isAutoAttackable(ru.agecold.gameserver.model.L2Character)
	 */
	@Override
