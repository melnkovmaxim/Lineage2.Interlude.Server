...
import ru.agecold.gameserver.datatables.EventDroplist;
...
public class FaenorInterface implements EngineInterface
{
    ...
    /* (non-Javadoc)
     * @see ru.agecold.gameserver.script.EngineInterface#getAllPlayers()
     */
     ...
     *
     * @see ru.agecold.gameserver.script.EngineInterface#addQuestDrop(int)
     */
