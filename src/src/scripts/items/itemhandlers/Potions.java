...
import ru.agecold.gameserver.network.serverpackets.ExUseSharedGroupItem;
...
public class Potions implements IItemHandler {
    ...
    public synchronized void useItem(L2PlayableInstance playable, L2ItemInstance item) {
        ...
        if (activeChar.getForbItem() > 0
                && CustomServerData.getInstance().isSpecialForrbid(activeChar.getForbItem(), item.getItemId())) {
